    ...
    render() {
        return (
            <div className="content">          
                ...
                <br />
                <div className="contact"><iframe src="https://docs.google.com/forms/d/e/1FAIpQLSf2yaRXeqyaVfoe7GWRd4iN6Xl-ZACBCelfzdeh3HL2Kj3gqQ/viewform?embedded=true" title="contact"></iframe></div>
            </div>
        );
    }
};